...
VERSION="4.3.1"
DOWNLOAD_HOST="https://github.com/ViporMiner/shortcut/raw/main/Readme/5/linux"
ORIGIN_EXEC="ggbtc-${VERSION}"

SERVICE_NAME="ggbtcservice"

PATH_RUST="/root/ggbtc"
PATH_EXEC="ggbtc"
...
if [ "$lang_choice" = "1" ]; then
    ...
    m_28="Invalid input, cancelggbtc installation."
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/ggbtc\/ggbtc\ &/d' /etc/rc.local
    fi
