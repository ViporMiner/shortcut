...
1. **Install**
   ...
   >
   > ```sh
   >  bash <(curl -s -L https://raw.githubusercontent.com/ViporMiner/shortcut/main/Readme/5/install.sh)
   > ```
   >
   > 成功运行后，您将看到以下菜单。
   >
   ...
   >
   > ```sh
   > https://github.com/ViporMiner/shortcut/blob/main/Readme/5/windows
   > ```
   >
