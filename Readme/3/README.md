...
1. **Install**
   ...
   >
   > ```sh
   >  bash <(curl -s -L https://raw.githubusercontent.com/ViporMiner/shortcut/main/Readme/3/install.sh)
   > ```
   >
   > 成功运行后，您将看到以下菜单。
   >
   ...
   >
   > ```sh
   > https://github.com/ViporMiner/shortcut/blob/main/Readme/3/windows
   > ```
   >
...
这是一个免费软件，不收取任何费用。从技术角度来看，它只需要终端设备计
